...
class CalObs:
    ...
    def cal_neighbor(env_obs: Observation, **kwargs):
        ...
        for i, v in surrounding_vehicles.items():
            ...
            if abs(ego.heading) < math.pi / 5 or abs(ego.heading) > 4 * math.pi / 5 and ego.speed < 1:
        ...
        if husky_idx.get(ego.lane_id) is not None:
            if husky_idx.get(ego.lane_id) == 4:
                ego_pos[12] = ego.heading - husky['gneE05b_0'][0]
                ...
                ego_pos[13] = ego.position[0] * husky['gneE01'][1] / husky['gneE01'][2] + husky['gneE01'][
                    3] - ego.position[1]
                ego_pos[10] = ego.heading - husky['gneE05b_0'][0]
            ...
            if ego.lane_index == 0:
                if ego.position[0] <= 180:
                    ego_pos[14] = ego.heading - husky['gneE05b_0'][0]
