...
class CalObs:
    ...
    def cal_heading_errors(env_obs: Observation, **kwargs):
        ...
        heading_errors = [
            math.sin(math.radians(wp.relative_heading(ego_heading)))
    ...
    def cal_neighbor(env_obs: Observation, **kwargs):
        ...
        husky = {'gneE05b_0': [-1.5713518822932961, -0.1, 180, 2.87],
                 'gneE01': [-1.571439578989722, -0.2, 310.92, 8.43, 3.69],
                 'gneE51_0': [-1.5715601518831366, -0.1, 130.92, 3.50]}
        husky_idx = {'gneE01': 1, 'gneE05b_0': 2, 'gneE51_0': 3, 'gneE05a_0': 4}
        ego_pos = ego.position[:2]
        ego_heading = np.asarray(float(ego.heading))
        if abs(ego_heading) < math.pi / 5 or abs(ego_heading) > 4 * math.pi / 5 and ego.speed < 1:
            ego_heading = -1.571439578989722
        for i, v in surrounding_vehicles.items():
            ...
            if abs(heading) < math.pi / 5 or abs(heading) > 4 * math.pi / 5 and speed < 1:
                heading = -1.571439578989722
        ...
        if husky_idx.get(ego.lane_id) is not None:
            if husky_idx.get(ego.lane_id) == 4:
                ego_pos[12] = ego_heading - husky['gneE05b_0'][0]
                ego_pos[13] = ego.position[0] * husky['gneE05b_0'][1] / husky['gneE05b_0'][2] + husky['gneE05b_0'][
                    3] - ego.position[1]
                ego_pos[10], ego_pos[11] = get_side_lane_info(ego.position, ego_heading)
                ego_pos[14] = 0
                ego_pos[15] = 0
            elif husky_idx.get(ego.lane_id) == 2:
                ego_pos[12] = ego_heading - husky['gneE01'][0]
                ego_pos[13] = ego.position[0] * husky['gneE01'][1] / husky['gneE01'][2] + husky['gneE01'][
                    3] - ego.position[1]
                ego_pos[10] = ego_heading - husky['gneE05b_0'][0]
                ego_pos[11] = ego.position[0] * husky['gneE05b_0'][1] / husky['gneE05b_0'][2] + husky['gneE05b_0'][
                    3] - ego.position[1]
                ego_pos[14], ego_pos[15] = get_side_lane_info(ego.position, ego_heading)
            elif husky_idx.get(ego.lane_id) == 3:
                ego_pos[12] = ego_heading - husky['gneE01'][0]
                ego_pos[13] = ego.position[0] * husky['gneE01'][1] / husky['gneE01'][2] + husky['gneE01'][
                    3] - ego.position[1]
                ego_pos[10] = ego_heading - husky['gneE51_0'][0]
            ...
            ego_pos[10] = ego_heading - husky['gneE01'][0]
            ...
            if ego.lane_index == 0:
                if ego.position[0] <= 180:
                    ego_pos[14] = ego_heading - husky['gneE05b_0'][0]
                    ego_pos[15] = ego.position[0] * husky['gneE05b_0'][1] / husky['gneE05b_0'][2] + husky['gneE05b_0'][
                        3] - ego.position[1]
                else:
                    ego_pos[14] = ego_heading - husky['gneE51_0'][0]
                    ego_pos[15] = (ego.position[0] - 180) * husky['gneE51_0'][1] / husky['gneE51_0'][2] + \
                                  husky['gneE51_0'][3] - ego.position[1]
            else:
                ego_pos[14] = ego_heading - husky['gneE01'][0]
